...
<body>
		<form:form id="inputForm" modelAttribute="bookChapter" action="${ctx}/bus/bookChapter/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				<tr>
					...
					<td class="width-35">
						<form:input path="chapter" htmlEscape="false" maxlength="11" class="form-control required digits"/>
					</td>
				</tr>
				<tr>
					<td class="width-15 active"><label class="pull-right">是否付费：</label></td>
					<td class="width-35">
						<form:radiobuttons path="isvip" items="${fns:getDictList('yes_no')}" itemLabel="label" itemValue="value" htmlEscape="false" class="i-checks required"/>
					</td>
				...
				<tr>
					<td class="width-15 active"><label class="pull-right">章节内容：</label></td>
