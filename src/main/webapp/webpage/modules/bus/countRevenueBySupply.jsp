...
<body class="gray-bg">
	...
	<div class="col-sm-12">
		<div class="col-sm-12">
			...
			<div class="pull-right">
				<form:form id="searchForm" modelAttribute="statistics" action="${ctx}/bus/statistics/coutRevenueBySupply" method="post" class="form-inline">
	...
	<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable">
		<thead>
			<tr>
				<th class="sort-column">内容提供商编号</th>
				<th class="sort-column">内容提供商名称</th>
