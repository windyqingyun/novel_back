...
<body class="gray-bg">
	...
	<div class="row">
	<div class="col-sm-12">
	<form:form id="searchForm" modelAttribute="statistics" action="${ctx}/bus/statistics/sumEarning" method="post" class="form-inline">
		 <div class="col-sm-12">
			<div class="pull-left">
	...
	<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable">
		<thead>
			<tr>
				<th  class="sort-column">开始日期</th>
				<th  class="sort-column">结束日期</th>
		...
		<c:forEach items="${list}" var="item">
			<tr>
				<td>
					<fmt:formatDate value="${statistics.beginDate}" pattern="yyyy-MM-dd"/>
				</td>
				<td>
					<fmt:formatDate value="${statistics.endDate}" pattern="yyyy-MM-dd"/>
				</td>
				<td>
					${item.sumRevenue}
				</td>
