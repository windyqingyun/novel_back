    ...
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            <span><img alt="image" class="img-circle" style="height:56px;width:56px;" src="${ctxStatic}/common/img/logo.jpg" /></span>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            <div class="row border-bottom">
                <nav class="navbar navbar-static-top hide" role="navigation" style="margin-bottom: 0">
            ...
            <div class="row content-tabs">
                ...
                <button class="roll-nav roll-right J_tabRight hide"><i class="fa fa-forward"></i>
                </button>
                <div class="btn-group roll-nav roll-right hide">
